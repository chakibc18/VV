...
import spoon.reflect.declaration.CtElement;
 public class X_CtTryImpl extends NODE{
CtTryImpl i_element;
public X_CtTryImpl (CtElement e, X_CtMethodImpl parent_method,X_CtConstructorImpl parent_constructor, X_CtClassImpl parent_class, X_CtInterfaceImpl parent_interface,X_CtPackageImpl parent_package, NODE  parent,String cls){
this.i_element=( CtTryImpl)  e;
