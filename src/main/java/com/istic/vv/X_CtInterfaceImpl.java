...
import spoon.reflect.declaration.CtPackage;
 public class X_CtInterfaceImpl extends NODE{
CtInterfaceImpl i_element;
public String node_simple_name;
ArrayList<String> code_lines = new ArrayList<>();

public X_CtInterfaceImpl (CtElement e, X_CtMethodImpl parent_method,X_CtConstructorImpl parent_constructor, X_CtClassImpl parent_class, X_CtInterfaceImpl parent_interface,X_CtPackageImpl parent_package, NODE  parent,String cls){
this.i_element=( CtInterfaceImpl)  e;
